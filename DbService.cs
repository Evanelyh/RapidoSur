...
namespace RapidoSurWinForms
{
    ...
    {
        private const string ConnectionString = "Server=localhost\\SQLEXPRESS;Database=rapido_sur;Trusted_Connection=True;TrustServerCertificate=True;";
        ...
        public List<Cliente> GetClientes()
        {
            ...
            conn.Open();
            using var cmd = new SqlCommand("SELECT * FROM cliente ORDER BY nombre, apellido", conn);
        ...
        public int AddCliente(Cliente c)
        {
            ...
            using var cmd = new SqlCommand(
                "INSERT INTO cliente (nombre, apellido, telefono, correo, direccion) VALUES (@nombre, @apellido, @telefono, @correo, @direccion); SELECT SCOPE_IDENTITY();", 
                conn);
        ...
        public List<Pedido> GetPedidos(string? estado = null)
        {
            ...
            while (reader.Read())
            {
                list.Add(new Pedido
                {
                    ...
                    DireccionEntrega = reader.GetString(reader.GetOrdinal("direccion_entrega")),
                    TipoCarga = reader.IsDBNull(reader.GetOrdinal("tipo_carga")) ? null : reader.GetString(reader.GetOrdinal("tipo_carga")),
                    PesoKg = reader.GetDecimal(reader.GetOrdinal("peso_kg")),
        ...
        public bool UpdatePedidoEstado(int idPedido, string estado)
        {
            using var conn = GetConnection();
            conn.Open();
            using var cmd = new SqlCommand("UPDATE pedido SET estado = @estado WHERE id_pedido = @id", conn);
            cmd.Parameters.AddWithValue("@estado", estado);
        ...
        public List<Vehiculo> GetVehiculos(string? estado = null)
        {
            ...
            while (reader.Read())
            {
                list.Add(new Vehiculo
                {
                    ...
                    CapacidadCargaKg = reader.GetDecimal(reader.GetOrdinal("capacidad_carga_kg")),
                    EstadoOperativo = reader.GetString(reader.GetOrdinal("estado_operativo")),
        ...
        public bool UpdateVehiculoEstado(int idVehiculo, string estado)
        {
            using var conn = GetConnection();
            conn.Open();
            using var cmd = new SqlCommand("UPDATE vehiculo SET estado_operativo = @estado WHERE id_vehiculo = @id", conn);
            cmd.Parameters.AddWithValue("@estado", estado);
        ...
        public List<Conductor> GetConductores(bool? disponible = null)
        {
            ...
            while (reader.Read())
            {
                ...
                {
                    IdConductor = reader.GetInt32(reader.GetOrdinal("id_conductor")),
                    Nombre = reader.GetString(reader.GetOrdinal("nombre")),
                    Apellido = reader.GetString(reader.GetOrdinal("apellido")),
                    NumLicencia = reader.GetString(reader.GetOrdinal("num_licencia")),
                    TipoLicencia = reader.IsDBNull(reader.GetOrdinal("tipo_licencia")) ? null : reader.GetString(reader.GetOrdinal("tipo_licencia")),
                    Telefono = reader.IsDBNull(reader.GetOrdinal("telefono")) ? null : reader.GetString(reader.GetOrdinal("telefono")),
                    Disponible = reader.GetBoolean(reader.GetOrdinal("disponible")),
                    FechaIngreso = reader.IsDBNull(reader.GetOrdinal("fecha_ingreso")) ? null : reader.GetDateTime(reader.GetOrdinal("fecha_ingreso"))
                });
            }
            return list;
        }
        ...
        public bool UpdateConductorDisponibilidad(int idConductor, bool disponible)
        {
            using var conn = GetConnection();
            conn.Open();
            using var cmd = new SqlCommand("UPDATE conductor SET disponible = @disponible WHERE id_conductor = @id", conn);
        ...
        public Operador? Login(string usuario, string clave)
        {
            using var conn = GetConnection();
            conn.Open();
            using var cmd = new SqlCommand("SELECT * FROM operador WHERE usuario = @user AND clave = @pass", conn);
            ...
            if (reader.Read())
            {
                return new Operador
                {
                    IdOperador = reader.GetInt32(reader.GetOrdinal("id_operador")),
                    Nombre = reader.GetString(reader.GetOrdinal("nombre")),
                    Apellido = reader.GetString(reader.GetOrdinal("apellido")),
        ...
        public List<Envio> GetEnvios(string? estado = null, int? idConductor = null)
        {
            ...
            while (reader.Read())
            {
                list.Add(new Envio
                {
                    IdEnvio = reader.GetInt32(reader.GetOrdinal("id_envio")),
                    IdPedido = reader.GetInt32(reader.GetOrdinal("id_pedido")),
                    IdVehiculo = reader.GetInt32(reader.GetOrdinal("id_vehiculo")),
                    IdConductor = reader.GetInt32(reader.GetOrdinal("id_conductor")),
                    IdOperador = reader.GetInt32(reader.GetOrdinal("id_operador")),
                    FechaAsignacion = reader.GetDateTime(reader.GetOrdinal("fecha_asignacion")),
                    FechaEntregaEstimada = reader.IsDBNull(reader.GetOrdinal("fecha_entrega_estimada")) ? null : reader.GetDateTime(reader.GetOrdinal("fecha_entrega_estimada")),
                    FechaEntregaReal = reader.IsDBNull(reader.GetOrdinal("fecha_entrega_real")) ? null : reader.GetDateTime(reader.GetOrdinal("fecha_entrega_real")),
                    RutaDescripcion = reader.IsDBNull(reader.GetOrdinal("ruta_descripcion")) ? null : reader.GetString(reader.GetOrdinal("ruta_descripcion")),
                    EstadoEnvio = reader.GetString(reader.GetOrdinal("estado_envio")),
                    ClienteNombre = reader.GetString(reader.GetOrdinal("cliente_nombre")),
                    DireccionEntrega = reader.GetString(reader.GetOrdinal("direccion_entrega")),
                    TipoCarga = reader.GetString(reader.GetOrdinal("tipo_carga")),
                    PesoKg = reader.GetDecimal(reader.GetOrdinal("peso_kg")),
                    VehiculoPlaca = reader.GetString(reader.GetOrdinal("vehiculo_placa")),
                    ConductorNombre = reader.GetString(reader.GetOrdinal("conductor_nombre"))
                });
            }
            return list;
        }
        ...
        public bool UpdateEnvioEstado(int idEnvio, string estado, string desc, string registradoPor, DateTime? nuevaFechaEst = null)
        {
            ...
            try
            {
                ...
                if (estado == "Entregado")
                {
                    query += ", fecha_entrega_real = GETDATE()";
                }
                ...
                else if (estado == "En Ruta")
                {
                    ...
                    using var cmdCond = new SqlCommand("UPDATE conductor SET disponible = 0 WHERE id_conductor = @id_cond", conn, transaction);
                    cmdCond.Parameters.AddWithValue("@id_cond", envio.IdConductor);
                    cmdCond.ExecuteNonQuery();
                }
        ...
        public List<HistorialEstado> GetHistorialEnvio(int idEnvio)
        {
            ...
            while (reader.Read())
            {
                list.Add(new HistorialEstado
                {
                    ...
                    RegistradoPor = reader.IsDBNull(reader.GetOrdinal("registrado_por")) ? null : reader.GetString(reader.GetOrdinal("registrado_por"))
                });
            }
            return list;
        }
        ...
        public List<Dictionary<string, object>> RunReport(string tipo, DateTime inicio, DateTime fin)
        {
            ...
            if (tipo == "Entregas")
            {
                query = @"SELECT e.id_envio AS 'ID Envio', p.id_pedido AS 'ID Pedido', 
                          CONCAT(c.nombre, ' ', c.apellido) AS 'Cliente',
                          p.tipo_carga AS 'Tipo Carga', p.peso_kg AS 'Peso (kg)',
                          v.placa AS 'Placa Vehiculo', 
            ...
            {
                query = @"SELECT h.id_historial AS 'ID Historial', e.id_envio AS 'ID Envio',
                          e.estado_envio AS 'Estado Envio',
            ...
            else // "Pedidos"
            {
                query = @"SELECT p.id_pedido AS 'ID Pedido', 
                          CONCAT(c.nombre, ' ', c.apellido) AS 'Cliente',
                          p.fecha_solicitud AS 'Fecha Solicitud', p.direccion_entrega AS 'Direccion Entrega',
                          p.tipo_carga AS 'Tipo Carga', p.peso_kg AS 'Peso (kg)',
